...
import com.yw.car.common.SPTableConstanct;
...
public class SPPushMessageProvider extends ContentProvider {
    ...
    static {
        ...
        MATCHER.addURI("com.yw.car.model.dao.messageProvider", SPTableConstanct.TABLE_NAME_MESSAGE, CODE_NOPARAM);
        //#表示数字cn.xyCompany.providers.personProvider/person/10,匹配返回CODE_PARAM,不匹配返回-1
        MATCHER.addURI("com.yw.car.model.dao.messageProvider", SPTableConstanct.TABLE_NAME_MESSAGE + "/#", CODE_PARAM);
    }
