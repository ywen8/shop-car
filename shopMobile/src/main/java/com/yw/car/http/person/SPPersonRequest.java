 ...
 * @version V1.0
 */
package com.yw.car.http.person;
...
import com.yw.car.model.distribute.SPDistributeGood;
import com.yw.car.model.distribute.SPDistributeModel;
import com.yw.car.model.distribute.SPDistributeOrder;
import com.yw.car.model.distribute.SPDistributeStore;
import com.yw.car.model.distribute.SPMoneyModel;
import com.yw.car.model.distribute.SPStoreGood;
import com.yw.car.model.distribute.SPStoreInfo;
import com.yw.car.model.distribute.SPStorePic;
import com.yw.car.model.distribute.SPTeamModel;
import com.yw.car.model.distribute.SPUserModel;
import com.yw.car.model.order.SPButtom;
...
import com.yw.car.model.shop.SPCollect;
...
public class SPPersonRequest {
     ...
     * @param successListener  success description
     * @param failuredListener failure description
     * @URL index.php?m=api&c=Order&a=team_list
     */
    public static void getGroupOrderList(RequestParams params, final SPSuccessListener successListener,
                                         final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Order", "team_list");
        SPMobileHttptRequest.get(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                ...
                try {
                    ...
                    if (status > 0) {
                        ...
                        if (order != null) {
                            ...
                            SPStore store = SPJsonUtil.fromJsonToModel(order.getStoreObject(), SPStore.class);
                            List<SPProduct> products = SPJsonUtil.fromJsonArrayToList(order.getProductsArray(), SPProduct.class);
                            if (order.getTeamFoundObject() != null) {
                                SPTeamFounder founder = SPJsonUtil.fromJsonToModel(order.getTeamFoundObject(), SPTeamFounder.class);
     ...
     */
    public static void cancelOrder(RequestParams orderID, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);
     ...
     * @param successListener  success description
     * @param failuredListener failure description
     * @URL index.php?m=api&c=User&a=getCartStoreCoupons
     */
