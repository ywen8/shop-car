            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (resultJson != null) {
                        ...
                        if (!resultJson.isNull("article")) {
                            JSONArray newObject = resultJson.getJSONArray("article");
                            commonModel.affiches = SPJsonUtil.fromJsonArrayToList(newObject, SPAffiche.class);
                        }
