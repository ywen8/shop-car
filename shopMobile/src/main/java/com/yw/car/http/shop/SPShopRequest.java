...
import com.yw.car.common.SPMobileConstants.Response;
...
import com.yw.car.model.shop.SPShopOrder;
import com.yw.car.model.shop.SPStore;
import com.yw.car.model.shop.SPTeamFounder;
import com.yw.car.model.shop.WxPayInfo;
...
public class SPShopRequest {
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/info
     */
    public static void getGroupProduct(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "info");
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        ...
                        if (result.has("collect")) {
                            int collect = result.getInt("collect");
                            if (product != null)
                                product.setIsCollect(collect);
                        }
                        SPCommentTitleModel commentTitleModel = null;
                        if (product.getCommentStatisticsObj() != null)
                            commentTitleModel = SPJsonUtil.fromJsonToModel(product.getCommentStatisticsObj(), SPCommentTitleModel.class);
                        if (commentTitleModel != null)
                            product.setCommentTitleModel(commentTitleModel);
                        if (result.has("filter_spec") && SPUtils.velidateJSONArray(result.get("filter_spec"))) {          //商品规格列表
                            Map<String, List<SPProductSpec>> specGroupMap = new HashMap<>();
                            JSONArray goodsSpecJsonArray = result.getJSONArray("filter_spec");
                        ...
                        if (result.has("team") && SPUtils.velidateJSONObject(result.get("team"))) {            //店铺数据
                            SPFightGroupsGood fightGroupsGood = SPJsonUtil.fromJsonToModel(result.getJSONObject("team"), SPFightGroupsGood.class);
                            dataJson.put("team", fightGroupsGood);
                        }
                        if (product != null && result.has("goods_images_list")) {
                            JSONArray jsonGarrys = result.getJSONArray("goods_images_list");
                            dataJson.put("gallery", jsonGarrys);
                        }
                        if (product != null)
                            dataJson.put("product", product);
                        if (result.has("spec_goods_price") && SPUtils.velidateJSONArray(result.get("spec_goods_price"))) {
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/ajaxTeamFound
     */
    public static void getGroupList(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "ajaxTeamFound");
        SPMobileHttptRequest.post(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONObject result = response.getJSONObject(Response.RESULT);
                        List<SPTeamFounder> teamFounders = new ArrayList<>();
                        if (!result.isNull("teamFounds"))
                            teamFounders = SPJsonUtil.fromJsonArrayToList(result.getJSONArray("teamFounds"), SPTeamFounder.class);
                        successListener.onRespone(msg, teamFounders);
                    } else {
                        failuredListener.onRespone(msg, -1);
                    }
                } catch (Exception e) {
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/found
     */
    public static void getGroupInfo(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "found");
        SPMobileHttptRequest.get(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        ...
                        int teamNum = 0;
                        SPTeamFounder founder = null;
                        SPFightGroupsGood groupsGood = null;
                        if (result.has("teamFollow"))
                            teamNum = result.getJSONArray("teamFollow").length();
                        jsonObject.put("teamNum", teamNum);
                        if (result.has("teamFound"))
                            founder = SPJsonUtil.fromJsonToModel(result.getJSONObject("teamFound"), SPTeamFounder.class);
                        if (founder != null)
                            jsonObject.put("founder", founder);
                        if (result.has("team"))
                            groupsGood = SPJsonUtil.fromJsonToModel(result.getJSONObject("team"), SPFightGroupsGood.class);
                        if (groupsGood != null)
                            jsonObject.put("team", groupsGood);
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/ajaxGetMore
     */
    public static void getGroupInfoList(int pageIndex, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        RequestParams params = new RequestParams();
        params.put("p", pageIndex);
        String url = SPMobileHttptRequest.getRequestUrl("Team", "ajaxGetMore");
        SPMobileHttptRequest.post(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    int status = response.getInt(Response.STATUS);
                    if (status > 0) {
                        JSONArray result = response.getJSONArray(Response.RESULT);
                        List<SPGroupGoods> groupGoods = SPJsonUtil.fromJsonArrayToList(result, SPGroupGoods.class);
                        successListener.onRespone(msg, groupGoods);
                    } else {
                        failuredListener.onRespone(msg, -1);
                    }
                } catch (Exception e) {
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/addOrder
     */
    public static void addOrder(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "addOrder");
        SPMobileHttptRequest.post(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONObject result = response.getJSONObject(Response.RESULT);
                        String orderSn = result.getString("order_sn");
                        successListener.onRespone(msg, orderSn);
                    } else {
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/order
     */
    public static void getConfirmOrder(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "order");
        SPMobileHttptRequest.get(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONObject jsonObject = new JSONObject();
                        JSONObject result = response.getJSONObject(Response.RESULT);
                        if (result.has("addressList")) {
                            SPConsigneeAddress address = SPJsonUtil.fromJsonToModel(result.getJSONObject("addressList"), SPConsigneeAddress.class);
                            if (address != null)
                                jsonObject.put("address", address);
                        }
                        if (result.has("userCartCouponList")) {
                            List<SPCoupon> coupons = SPJsonUtil.fromJsonArrayToList(result.getJSONArray("userCartCouponList"), SPCoupon.class);
                            if (coupons != null)
                                jsonObject.put("coupon", coupons);
                        }
                        if (result.has("order")) {
                            SPOrder order = SPJsonUtil.fromJsonToModel(result.getJSONObject("order"), SPOrder.class);
                            if (order != null)
                                jsonObject.put("order", order);
                        }
                        if (result.has("store")) {
                            SPStore store = SPJsonUtil.fromJsonToModel(result.getJSONObject("store"), SPStore.class);
                            if (result.has("couponNum"))
                                store.setCouponNum(result.getInt("couponNum"));
                            if (store != null)
                                jsonObject.put("store", store);
                        }
                        if (result.has("order_goods")) {
                            SPProduct product = SPJsonUtil.fromJsonToModel(result.getJSONObject("order_goods"), SPProduct.class);
                            if (product != null)
                                jsonObject.put("product", product);
                        }
                        if (result.has("userInfo")) {
                            SPUser user = SPJsonUtil.fromJsonToModel(result.getJSONObject("userInfo"), SPUser.class);
                            if (user != null)
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php/Api/Team/getOrderInfo
     */
    public static void getOrderInfo(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "getOrderInfo");
        SPMobileHttptRequest.get(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONObject jsonObject = new JSONObject();
                        JSONObject result = response.getJSONObject(Response.RESULT);
                        if (result.has("couponList")) {
                            List<SPCoupon> coupons = SPJsonUtil.fromJsonArrayToList(result.getJSONArray("couponList"), SPCoupon.class);
                            if (coupons != null)
                                jsonObject.put("coupon", coupons);
                        }
                        if (result.has("order")) {
     ...
     * @url index.php/Api/Team/getOrderInfo
     */
    public static void submitOrderInfo(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);
        ...
        SPMobileHttptRequest.post(url, params, new JsonHttpResponseHandler() {
            ...
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONObject result = response.getJSONObject(Response.RESULT);
                        String amount = result.getString("order_amount");
                            ...
                            if (resultJson.has("goods")) {
                                ...
                                if (!SPStringUtils.isEmpty(pointRate) && !SPStringUtils.isEmpty(goodsPrice)) {
                                    ...
                                    if ((b1.subtract(b2.divide(b3))).doubleValue() <= 0)
                                        integralPrice = (int) Math.ceil((b1.multiply(b3)).doubleValue()) + "金豆";
                                    else
                                        integralPrice = "¥" + b1.subtract(b2.divide(b3)) + "+" + exchangeIntegral + "金豆";
     ...
     * @param successListener
     * @param failuredListener
     * @url index.php?m=Api&c=Team&a=AjaxTeamList
     */
    public static void getFightGroupList(int page, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);

        String url = SPMobileHttptRequest.getRequestUrl("Team", "AjaxTeamList");
        RequestParams params = new RequestParams();
        params.put("p", page);
        SPMobileHttptRequest.post(url, params, new JsonHttpResponseHandler() {
            @Override
            public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                try {
                    ...
                    if (status > 0) {
                        JSONArray jsonResult = response.getJSONArray(Response.RESULT);
                        List<SPFightGroupsGood> fightGroupsGoods = SPJsonUtil.fromJsonArrayToList(jsonResult, SPFightGroupsGood.class);
                        successListener.onRespone(msg, fightGroupsGoods);
                    } else {
                        failuredListener.onRespone(msg, status);
                    }
                } catch (Exception e) {
