...
public class SPMobileConstants {
    ...
    public static final String BASE_HOST = "http://www.nxznzh.com";// http://192.168.0.222                            //URL
    ...
    //取消详情
    public static final String URL_ORDER_REFUND_DETAIL = BASE_HOST + "/index.php?m=api&c=Order&a=cancel_order_info&order_id=%s";
    //商品详情内容
    public static final String URL_GOODS_DETAIL_CONTENT = BASE_HOST + "/index.php?m=api&c=goods&a=goodsContent&id=%s";
    //查看订单商品退款
    public static final String URL_GOODS_ORDER_CHECK = BASE_HOST + "/index.php?m=api&c=order&a=return_goods_info";
    //入驻首页
    public static final String URL_NEWJOIN_AGREEMENT = BASE_HOST + "/index.php?m=Api&c=Newjoin&a=agreement";

    public static final String URL_GETAREA = "http://v.juhe.cn/wz/citys?key=f4c7ad78424e814df8730aae76a22d05";
    public static final String URL_SEAECH = "http://v.juhe.cn/wz/citys?key=fa0283b2d224f5fa41a59ed616f0f709";
    public static final String URL_SHENGFEN = "http://v.juhe.cn/usedcar/province?dtype=&key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_CITY = "http://v.juhe.cn/usedcar/city?dtype=&key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_CARBRAND = "http://v.juhe.cn/usedcar/brand?dtype=&key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_XILIE = "http://v.juhe.cn/usedcar/series?dtype=&key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_CHEXING = "http://v.juhe.cn/usedcar/car?dtype=&key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_SEARCH_ASSESS = "http://v.juhe.cn/usedcar/assess?key=6c4e70c83fb586ce70aa787282f6872c";
    public static final String URL_WEIZHANGSHENGFEN = "http://v.juhe.cn/sweizhang/citys?dtype=&key=fa0283b2d224f5fa41a59ed616f0f709";
    ...
    public static final String ACTION_GROUP_SPEC_CHNAGE = "com.tpshop.mall.group.spec_change";      //拼团商品规格改变
    ...
    public static final int tagCancelInfo = 703;                                                    //取消详情
    ...
    public static String pluginQQAppid = "1106720860";
    public static String pluginQQSecret = "WGyClB3RMmOBNC2K";
    ...
    /*** 百度地图相关 **/
    public static String baidumap_mcode = "0D:B5:1A:42:F2:EA:3F:D4:C2:13:BB:0E:31:3B:BF:59:C5:5E:1C:1F;com.yw.car";    //安全码
    public static String baidumap_ak = "WimtUcTG0fan12aW8t2n1er9ppSXU2gj";        //密钥
