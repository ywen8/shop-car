...
public class SPBNEventHandler {
    
    private SPBNEventDialog mEventDialog = null;
    
    private static class LazyLoader {
        private static SPBNEventHandler mInstance = new SPBNEventHandler();
    }
    
    public static SPBNEventHandler getInstance() {
        return LazyLoader.mInstance;
    }
    
    private SPBNEventHandler() {
    }
    
    public SPBNEventDialog getDialog(Context ctx) {
        if (mEventDialog == null) {
            mEventDialog = new SPBNEventDialog(ctx);
        }
        return mEventDialog;
    }
