...
import com.yw.car.fragment.SPProductListFilterFragment;
...
import com.yw.car.widget.SPProductFilterTabView;
...
public class SPProductListSearchResultActivity extends SPBaseActivity implements SPProductListSecAdapter.OnItemClickListener, OnRefreshListener,
    ...
    protected void onCreate(Bundle bundle) {
        ...
        setContentView(com.yw.car.R.layout.product_list);
        getWindow().setFeatureInt(Window.FEATURE_CUSTOM_TITLE, com.yw.car.R.layout.product_list_header);
    ...
    public void initSubViews() {
        mFilterTabView = (SPProductFilterTabView) findViewById(com.yw.car.R.id.filter_tabv);
        mFilterTabView.setOnSortClickListener(this);
        refreshRecyclerView = (SuperRefreshRecyclerView) findViewById(com.yw.car.R.id.super_recyclerview);
        emptyView = findViewById(com.yw.car.R.id.empty_lstv);
        ...
        syntheisTxtv = (TextView) findViewById(com.yw.car.R.id.sort_button_synthesis);
        salenumTxtv = (TextView) findViewById(com.yw.car.R.id.sort_button_salenum);
        priceTxtv = (TextView) findViewById(com.yw.car.R.id.sort_button_price);
        searchText = (EditText) findViewById(com.yw.car.R.id.search_edtv);
        backImgv = (ImageView) findViewById(com.yw.car.R.id.title_back_imgv);
        mDrawerLayout = (DrawerLayout) findViewById(com.yw.car.R.id.drawerlayout);
        SPMobileApplication.getInstance().productListType = 2;
        mFilterFragment = (SPProductListFilterFragment) getSupportFragmentManager().findFragmentById(com.yw.car.R.id.right_rlayout);
    }
