...
import com.yw.car.adapter.SPPushMessageListAdapter;
import com.yw.car.dao.SPPushMessageDao;
 ...
 */
@EActivity(com.yw.car.R.layout.push_message)
public class SPPushMessageListActivity extends SPBaseActivity {

    @ViewById(com.yw.car.R.id.push_message_lstv)
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setCustomerTitle(true, true, getString(com.yw.car.R.string.title_push_message));
