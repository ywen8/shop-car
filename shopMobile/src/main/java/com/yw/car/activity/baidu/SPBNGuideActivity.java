 ...
 * @author sunhao04
 */
public class SPBNGuideActivity extends SPBaseActivity {

    private final String TAG = SPBNGuideActivity.class.getName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SPBaiDuBaseActivity.activityList.add(this);
        createHandler();
        ...
        if (intent != null) {
            ...
            if (bundle != null) {
                mBNRoutePlanNode = (BNRoutePlanNode) bundle.getSerializable(SPBaiDuBaseActivity.ROUTE_PLAN_NODE);
            }
        }
        //显示自定义图标
        if (hd != null) {
...
//        SPBNEventHandler.getInstance().getDialog(this);
//        SPBNEventHandler.getInstance().showDialog();
    }
    ...
    protected void onDestroy() {
        ...
        SPBaiDuBaseActivity.activityList.remove(this);
        SPBNEventHandler.getInstance().disposeDialog();
    }
                ...
                public void handleMessage(android.os.Message msg) {
                    if (msg.what == MSG_SHOW) {
                        ...
                        BNRouteGuideManager.getInstance().resetEndNodeInNavi(
                                new BNRoutePlanNode(109.01079, 34.254225, "百度大厦11", null, CoordinateType.GCJ02));
                    }
                }
