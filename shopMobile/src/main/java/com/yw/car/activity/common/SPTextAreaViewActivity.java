 ...
 */
@EActivity(com.yw.car.R.layout.text_area)
public class SPTextAreaViewActivity extends SPBaseActivity {

    int maxLimit = 50;

    @ViewById(com.yw.car.R.id.value_edtv)
    EditText valueEtv;

    @ViewById(com.yw.car.R.id.limit_txtv)
    TextView limitTxtv;
    ...
    @Click({com.yw.car.R.id.ok_btn})
    public void onButtonClick(View v) {
        if (v.getId() == com.yw.car.R.id.ok_btn) {
