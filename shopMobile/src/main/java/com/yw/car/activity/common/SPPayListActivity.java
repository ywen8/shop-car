...
import com.yw.car.utils.PayResult;
 ...
 */
@EActivity(com.yw.car.R.layout.pay_list)
public class SPPayListActivity extends SPBaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        super.setCustomerTitle(true, true, getString(com.yw.car.R.string.title_pay_list));
    ...
    @Click({com.yw.car.R.id.pay_alipay_aview, com.yw.car.R.id.pay_wechat_aview})
    public void onButtonClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.pay_alipay_aview:
                aliPay();
                break;
            case com.yw.car.R.id.pay_wechat_aview:
                wxPay();
                break;
        }
    }
    ...
    public void startupWxPay() {
        ...
        String extData = (mWxPayInfo.getExtData() != null) ? mWxPayInfo.getExtData() : getString(com.yw.car.R.string.app_name);
