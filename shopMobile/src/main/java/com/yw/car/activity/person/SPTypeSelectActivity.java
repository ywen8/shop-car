...
import com.yw.car.utils.SPTypeUtil;
...
@EActivity(com.yw.car.R.layout.type_select_citiy)
public class SPTypeSelectActivity extends SPBaseActivity {

    @ViewById(com.yw.car.R.id.tv_tittle)
    TextView tvTittle;
    ...
    private int[] ids = {com.yw.car.R.id.rb_first, com.yw.car.R.id.rb_second, com.yw.car.R.id.rb_third};
    ...
    @Click({com.yw.car.R.id.rb_first, com.yw.car.R.id.rb_second, com.yw.car.R.id.rb_third, com.yw.car.R.id.btn_back, com.yw.car.R.id.btn_right})
    public void onViewClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.btn_back:
                finish();
                break;
            case com.yw.car.R.id.btn_right:      //确定
                ...
                finish();
                break;
            case com.yw.car.R.id.rb_first:      //一级分类
                current = 0;
                merchantsType.setSecondType("");
                merchantsType.setThirdType("");
                tvs[1].setText("二级分类");
                ...
                thirdTypeString = "";
                break;
            case com.yw.car.R.id.rb_second:      //二级分类
                ...
                thirdTypeString = "";
                break;
            case com.yw.car.R.id.rb_third:      //三级分类
