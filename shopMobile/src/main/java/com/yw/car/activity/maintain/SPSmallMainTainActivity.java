...
public class SPSmallMainTainActivity extends SPBaseActivity implements View.OnClickListener {
...
//                Intent intent = new Intent(SPSmallMainTainActivity.this, SPSuccessActivity_.class);
//                startActivity(intent);
//                finish();
                showLoadingSmallToast();
                RequestParams params = new RequestParams();
                params.add("maintain_type", "2");
