 ...
 * @author zw
 */
@EActivity(com.yw.car.R.layout.activity_spoffline_alliance)
public class SPOfflineAllianceActivity extends SPBaseActivity {

    @ViewById(com.yw.car.R.id.national_mall_image)
    ImageView nationalMallImage;

    @ViewById(com.yw.car.R.id.local_mall_image)
    ImageView localMallImage;

    @ViewById(com.yw.car.R.id.job_hunting_image)
    ImageView jobHuntingImage;

    @ViewById(com.yw.car.R.id.coupon_center_image)
    ImageView couponCenterImage;

    @ViewById(com.yw.car.R.id.local_news_image)
    ImageView localNewsImage;

    @ViewById(com.yw.car.R.id.fight_groups_image)
                ...
                switch (event.getAction()) {
                    case MotionEvent.ACTION_DOWN:
                        ...
                        if (bitmap1.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            nationalMallImage.setImageResource(com.yw.car.R.drawable.national_mall_press);
                        } else if (bitmap2.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            localMallImage.setImageResource(com.yw.car.R.drawable.local_mall_press);
                        } else if (bitmap3.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            jobHuntingImage.setImageResource(com.yw.car.R.drawable.job_hunting_press);
                        } else if (bitmap4.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            couponCenterImage.setImageResource(com.yw.car.R.drawable.coupon_center_press);
                        } else if (bitmap5.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            localNewsImage.setImageResource(com.yw.car.R.drawable.local_news_press);
                        } else if (bitmap6.getPixel((int) (event.getX()), ((int) event.getY())) != 0) {
                            fightGroupsImage.setImageResource(com.yw.car.R.drawable.fight_groups_press);
                        }
                        break;
                    case MotionEvent.ACTION_UP:
                        nationalMallImage.setImageResource(com.yw.car.R.drawable.national_mall);
                        localMallImage.setImageResource(com.yw.car.R.drawable.local_mall);
                        jobHuntingImage.setImageResource(com.yw.car.R.drawable.job_hunting);
                        couponCenterImage.setImageResource(com.yw.car.R.drawable.coupon_center);
                        localNewsImage.setImageResource(com.yw.car.R.drawable.local_news);
                        fightGroupsImage.setImageResource(com.yw.car.R.drawable.fight_groups);
