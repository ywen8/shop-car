 ...
 * @author 飞龙
 */
@EActivity(com.yw.car.R.layout.consignee_address_edit)
public class SPConsigneeAddressEditActivity extends SPBaseActivity implements SPConfirmDialog.ConfirmDialogListener {

    @ViewById(com.yw.car.R.id.consignee_name_edtv)
    EditText consigneeEdtv;                  //收货人姓名

    @ViewById(com.yw.car.R.id.consignee_mobile_edtv)
    EditText mobileEdtv;                     //收货人电话

    @ViewById(com.yw.car.R.id.consignee_region_txtv)
    TextView regionTxtv;                     //收货地址

    @ViewById(com.yw.car.R.id.consignee_address_edtv)
    EditText addressEdtv;                    //收货地址

    @ViewById(com.yw.car.R.id.set_default_switch)
    ...
    public void onCreate(Bundle savedInstanceState) {
        super.setCustomerTitle(true, true, getString(com.yw.car.R.string.title_consignee));
    ...
    public void initSubViews() {
        if (consignee != null) {
            ...
            compliteTv.setTextColor(this.getResources().getColor(com.yw.car.R.color.color_font_666));
    ...
    @Click({com.yw.car.R.id.submit_btn, com.yw.car.R.id.consignee_region_txtv})
    public void onViewClick(View view) {
        switch (view.getId()) {
            case com.yw.car.R.id.submit_btn:
                if (!checkData()) return;
                ...
                break;
            case com.yw.car.R.id.consignee_region_txtv:
