...
import com.yw.car.adapter.SPFlashSaleTabAdapter;
...
@EActivity(com.yw.car.R.layout.flash_sale)
public class SPFlashSaleActivity extends SPBaseActivity {
    ...
    @ViewById(com.yw.car.R.id.view_pager)
    ViewPager mViewPager;

    @ViewById(com.yw.car.R.id.group_ad_imgv)
    ImageView mAdImgv;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.setCustomerTitle(true, true, getString(com.yw.car.R.string.title_flash_sale));
        ...
        SPShopRequest.getFlashSaleTime(new SPSuccessListener() {
            ...
            public void onRespone(String msg, Object response) {
                ...
                if (listModel.ad != null) {
                    mAd = listModel.ad;
                    Glide.with(SPFlashSaleActivity.this).load(SPUtils.getImageUrl(mAd.getAdCode())).placeholder(com.yw.car.R.drawable.icon_product_null)
