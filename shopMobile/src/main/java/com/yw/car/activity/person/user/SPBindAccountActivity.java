...
@EActivity(com.yw.car.R.layout.activity_bind_account)
public class SPBindAccountActivity extends SPBaseActivity implements View.OnClickListener {

    @ViewById(com.yw.car.R.id.head_mimgv)
    SimpleDraweeView headImgv;

    @ViewById(com.yw.car.R.id.account_type)
    TextView accountType;

    @ViewById(com.yw.car.R.id.account_name)
    TextView accountName;

    @ViewById(com.yw.car.R.id.regist_btn)
    Button registBtn;

    @ViewById(com.yw.car.R.id.text1)
    TextView text1;

    @ViewById(com.yw.car.R.id.text2)
    TextView text2;

    @ViewById(com.yw.car.R.id.text3)
    TextView text3;
    ...
    public void initData() {
        ...
        text1.setText("为了给您更好的服务，请关联一个" + getString(com.yw.car.R.string.app_name) + "账号");
        text2.setText("还没有" + getString(com.yw.car.R.string.app_name) + "账号？");
        text3.setText("已有" + getString(com.yw.car.R.string.app_name) + "账号？");
    }

    @Override
    public void onClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.regist_btn:      //注册
