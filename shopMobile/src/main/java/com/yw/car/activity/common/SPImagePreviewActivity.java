 ...
 * @author 飞龙
 */
@EActivity(com.yw.car.R.layout.image_preview)
public class SPImagePreviewActivity extends Activity {

    private int index;
    private List<String> imageUrls;

    @ViewById(com.yw.car.R.id.image_pager)
    ViewPager mPager;

    @ViewById(com.yw.car.R.id.pointer_layout)
    ...
    public void initSubViews() {
        mPager = (ViewPager) findViewById(com.yw.car.R.id.image_pager);
        ...
        mPager.setAdapter(new PagerAdapter() {
            ...
            public Object instantiateItem(ViewGroup container, int position) {
                ...
                Glide.with(SPImagePreviewActivity.this).load(imageUrls.get(position)).asBitmap().fitCenter().placeholder(com.yw.car.R.drawable.icon_product_null)
    ...
    public void onPageChange(int page) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (v instanceof ImageView) {
                if (i == page)
                    v.setBackgroundResource(com.yw.car.R.drawable.ic_home_arrows_focus);
                else
                    v.setBackgroundResource(com.yw.car.R.drawable.ic_home_arrows_normal);
            }
        }
    }
    ...
    public void buildPointer(ViewGroup pLayout, int count) {
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (i == 0)        //默认选中第一张图片
                pointerImgv[i].setBackgroundResource(com.yw.car.R.drawable.ic_home_arrows_focus);
            else
                pointerImgv[i].setBackgroundResource(com.yw.car.R.drawable.ic_home_arrows_normal);
