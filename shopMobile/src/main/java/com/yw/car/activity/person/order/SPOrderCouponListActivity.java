...
import com.yw.car.adapter.SPOrderCouponListAdapter;
...
@EActivity(com.yw.car.R.layout.order_coupon_list)
public class SPOrderCouponListActivity extends SPBaseActivity implements OnRefreshListener, SPOrderCouponListAdapter.ItemClickListener {
    ...
    public void initSubViews() {
        ...
        View mEmptyView = findViewById(com.yw.car.R.id.empty_lstv);
        ...
        tvCommit.setText("确定");
        tvCommit.setTextColor(this.getResources().getColor(com.yw.car.R.color.light_red));
