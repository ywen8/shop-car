...
import com.yw.car.adapter.SPProductShowListAdapter;
...
public class SPProductShowListActivity extends SPBaseActivity {
    ...
    protected void onCreate(Bundle bundle) {
        super.setCustomerTitle(true, true, getString(com.yw.car.R.string.title_product_list));
