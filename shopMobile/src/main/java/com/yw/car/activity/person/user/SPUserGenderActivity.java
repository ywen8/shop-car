...
@EActivity(com.yw.car.R.layout.activity_user_gender)
public class SPUserGenderActivity extends SPBaseActivity {

    int selectIndex = -1;

    @ViewById(com.yw.car.R.id.rad_male)
    RadioButton male;

    @ViewById(com.yw.car.R.id.rad_female)
    RadioButton female;

    @Override
    protected void onCreate(Bundle arg0) {
        setCustomerTitle(true, true, getString(com.yw.car.R.string.user_sex));
        super.onCreate(arg0);
