...
@EActivity(com.yw.car.R.layout.activity_spreceiving_completed)
public class SPPayCompletedSecActivity extends SPBaseActivity implements View.OnClickListener {

    @ViewById(com.yw.car.R.id.check_order_btn)
    Button check_order;

    @ViewById(com.yw.car.R.id.pay_money_txtv)
    TextView payMoneyText;

    @ViewById(com.yw.car.R.id.pay_trade_no_txtv)
    ...
    public void initSubViews() {
        ...
        tvComplete.setTextColor(this.getResources().getColor(com.yw.car.R.color.gray));
    ...
    public void initData() {
        ...
        tradeNoSpanStr.setSpan(new ForegroundColorSpan(getResources().getColor(com.yw.car.R.color.light_red)), startIndex, endIndex,
                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);       //设置区域内文字颜色为洋红色
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.check_order_btn:
                if (isVirtual) {
