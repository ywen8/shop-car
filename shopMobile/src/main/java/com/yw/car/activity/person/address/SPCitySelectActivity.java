package com.yw.car.activity.person.address;
...
import com.yw.car.model.person.SPRegionModel;
import com.yw.car.utils.SPCityUtil;
...
@EActivity(com.yw.car.R.layout.consignee_select_citiy)
public class SPCitySelectActivity extends SPBaseActivity {

    @ViewById(com.yw.car.R.id.btn_right)
    Button btn_right;

    @ViewById(com.yw.car.R.id.btn_back)
    RelativeLayout btn_back;

    @ViewById(com.yw.car.R.id.lv_city)
    ListView lv_city;
    ...
    private int[] ids = {com.yw.car.R.id.rb_province, com.yw.car.R.id.rb_city, com.yw.car.R.id.rb_district, com.yw.car.R.id.rb_town};           //顶栏省市县
    ...
    public void setTextViewSelect() {
        for (int i = 0; i < tvs.length; i++) {
            if (current == i)
                tvs[i].setBackgroundColor(getResources().getColor(com.yw.car.R.color.botton_nav_bg));
            else
                tvs[i].setBackgroundColor(Color.WHITE);
        }
        if (current == 4)
            tvs[3].setBackgroundColor(getResources().getColor(com.yw.car.R.color.botton_nav_bg));
    }

    @Click({com.yw.car.R.id.rb_province, com.yw.car.R.id.rb_city, com.yw.car.R.id.rb_district, com.yw.car.R.id.rb_town, com.yw.car.R.id.btn_back, com.yw.car.R.id.btn_right})
    public void onViewClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.btn_back:
                finish();
                break;
            case com.yw.car.R.id.btn_right:
                ...
                if (flag) {
                    showToast(getString(com.yw.car.R.string.toast_address_nocompletion));
                    return;
                }
                ...
                finish();
                break;
            case com.yw.car.R.id.rb_province:      //省份
                current = 0;
                consignee.setCity("");
                consignee.setDistrict("");
                consignee.setTown("");
                tvs[1].setText(com.yw.car.R.string.city);
                tvs[2].setText(com.yw.car.R.string.district);
                tvs[3].setText(com.yw.car.R.string.town);
                util.initProvince();
                setTextViewSelect();
                break;
            case com.yw.car.R.id.rb_city:      //城市
                if (StringUtils.isEmpty(consignee.getProvince())) {
                    showToast(getString(com.yw.car.R.string.toast_no_select_province));
                    return;
                }
                consignee.setDistrict("");
                consignee.setTown("");
            ...
            case com.yw.car.R.id.rb_district:      //区县
                ...
                break;
            case com.yw.car.R.id.rb_town:      //镇/街道
                if (StringUtils.isEmpty(consignee.getProvince()) || StringUtils.isEmpty(consignee.getCity())
    ...
    private class CityAdapter extends ArrayAdapter<SPRegionModel> {
        ...
        public View getView(int position, View v, @NonNull ViewGroup arg2) {
            v = inflater.inflate(com.yw.car.R.layout.consignee_select_citiy_item, null);
            TextView tv_city = (TextView) v.findViewById(com.yw.car.R.id.tv_city);
