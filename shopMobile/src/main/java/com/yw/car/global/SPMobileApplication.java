...
public class SPMobileApplication extends Application {
    ...
    public static int[] IMAGES = new int[]{com.yw.car.R.drawable.w1, com.yw.car.R.drawable.w2, com.yw.car.R.drawable.w3, com.yw.car.R.drawable.w4};               //引导页图片
