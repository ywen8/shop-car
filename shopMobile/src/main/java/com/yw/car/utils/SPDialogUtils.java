...
public class SPDialogUtils {
    ...
    public static void showToast(Context context, String message) {
        View toastRoot = LayoutInflater.from(context).inflate(com.yw.car.R.layout.toast, null);            //加载Toast布局
        TextView mTextView = (TextView) toastRoot.findViewById(com.yw.car.R.id.message);
