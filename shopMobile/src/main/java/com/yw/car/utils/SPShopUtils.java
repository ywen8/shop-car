...
public class SPShopUtils {
    ...
    /**
     * 根据规格获取teamId(判断当前规格是否是拼团)
     */
    public static int getTeamId(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            return specPrice.getTeamId();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return 0;
     ...
     * 根据规格获取promId
     */
    public static int getPromId(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            return specPrice.getPromId();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return 0;
     ...
     * 根据规格获取拼团价格
     */
    public static String getGroupprice(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            if (specPrice == null) return "";
            return specPrice.getTeamPrice();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * 根据规格获取拼团描述
     */
    public static String getGroupDesc(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            if (specPrice == null) return "";
            return specPrice.getShareDesc();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * 根据规格获取拼团活动状态
     */
    public static String getStatusDesc(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            if (specPrice == null) return "";
            return specPrice.getStatusDesc();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
     ...
     * 根据规格获取拼团人数
     */
    public static String getNeeder(String key, Map<String, SPSpecPriceModel> specPriceMap) {
        try {
            SPSpecPriceModel specPrice = specPriceMap.get(key);
            if (specPrice == null) return "";
            return specPrice.getNeeder();
        } catch (Exception e) {
            e.printStackTrace();
        }
        return null;
