...
import com.yw.car.activity.common.SPPayCompletedSecActivity_;
import com.yw.car.activity.common.SPPayListActivity;
...
public class WXPayEntryActivity extends Activity implements IWXAPIEventHandler, View.OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.yw.car.R.layout.wx_pay_result);
        initSubViews();
        initEvent();
        initData();
    ...
    public void initSubViews() {
        mPayCompletedImgv = (ImageView) findViewById(com.yw.car.R.id.pay_completed_imgv);
        mTradeNoTxtv = (TextView) findViewById(com.yw.car.R.id.pay_trade_no_txtv);
        mPayMoneyTxtv = (TextView) findViewById(com.yw.car.R.id.pay_money_txtv);
        mPayTipTxtv = (TextView) findViewById(com.yw.car.R.id.pay_tip_txtv);
        mOrderBtn = (Button) findViewById(com.yw.car.R.id.order_btn);
        mHomeOrPayBtn = (Button) findViewById(com.yw.car.R.id.home_or_repay_btn);
    }
    ...
    public void onResp(BaseResp resp) {
        if (resp.getType() == ConstantsAPI.COMMAND_PAY_BY_WX) {  //微信结果返回
            if (resp.errCode == BaseResp.ErrCode.ERR_OK) {       //用户取消授权
                ...
                SPDialogUtils.showToast(this, "用户取消授权" + getString(com.yw.car.R.string.weixin_pay));
                mPayStatus = -1;
                this.finish();
            }
        }
