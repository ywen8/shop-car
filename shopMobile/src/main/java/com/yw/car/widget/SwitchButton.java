...
public class SwitchButton extends CompoundButton {
    ...
    private void init(AttributeSet attrs) {
        ...
        int textExtra = 0;
        int textAdjust = 0;
        TypedArray ta = attrs == null ? null : getContext().obtainStyledAttributes(attrs, com.yw.car.R.styleable.SwitchButton);
        if (ta != null) {
            thumbDrawable = ta.getDrawable(com.yw.car.R.styleable.SwitchButton_kswThumbDrawable);
            thumbColor = ta.getColorStateList(com.yw.car.R.styleable.SwitchButton_kswThumbColor);
            margin = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbMargin, margin);
            marginLeft = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbMarginLeft, margin);
            marginRight = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbMarginRight, margin);
            marginTop = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbMarginTop, margin);
            marginBottom = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbMarginBottom, margin);
            thumbWidth = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbWidth, thumbWidth);
            thumbHeight = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbHeight, thumbHeight);
            thumbRadius = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswThumbRadius, thumbRadius);
            backRadius = ta.getDimension(com.yw.car.R.styleable.SwitchButton_kswBackRadius, backRadius);
            backDrawable = ta.getDrawable(com.yw.car.R.styleable.SwitchButton_kswBackDrawable);
            backColor = ta.getColorStateList(com.yw.car.R.styleable.SwitchButton_kswBackColor);
            thumbRangeRatio = ta.getFloat(com.yw.car.R.styleable.SwitchButton_kswThumbRangeRatio, thumbRangeRatio);
            animationDuration = ta.getInteger(com.yw.car.R.styleable.SwitchButton_kswAnimationDuration, animationDuration);
            fadeBack = ta.getBoolean(com.yw.car.R.styleable.SwitchButton_kswFadeBack, true);
            tintColor = ta.getColor(com.yw.car.R.styleable.SwitchButton_kswTintColor, tintColor);
            textOn = ta.getString(com.yw.car.R.styleable.SwitchButton_kswTextOn);
            textOff = ta.getString(com.yw.car.R.styleable.SwitchButton_kswTextOff);
            textThumbInset = ta.getDimensionPixelSize(com.yw.car.R.styleable.SwitchButton_kswTextThumbInset, 0);
            textExtra = ta.getDimensionPixelSize(com.yw.car.R.styleable.SwitchButton_kswTextExtra, 0);
            textAdjust = ta.getDimensionPixelSize(com.yw.car.R.styleable.SwitchButton_kswTextAdjust, 0);
            ta.recycle();
        }
        ...
        if (mTintColor == 0) {
            ...
            boolean found = getContext().getTheme().resolveAttribute(com.yw.car.R.attr.colorAccent, typedValue, true);
            if (found)
