...
public class SPStarView extends RelativeLayout implements View.OnClickListener {
    ...
    public SPStarView(Context context, AttributeSet attrs) {
        ...
        View parent = LayoutInflater.from(context).inflate(com.yw.car.R.layout.star_view, this, true);
        star1Btn = (Button) parent.findViewById(com.yw.car.R.id.star1_btn);
        star1Btn.setOnClickListener(this);
        starList.add(star1Btn);
        star2Btn = (Button) parent.findViewById(com.yw.car.R.id.star2_btn);
        star2Btn.setOnClickListener(this);
        starList.add(star2Btn);
        star3Btn = (Button) parent.findViewById(com.yw.car.R.id.star3_btn);
        star3Btn.setOnClickListener(this);
        starList.add(star3Btn);
        star4Btn = (Button) parent.findViewById(com.yw.car.R.id.star4_btn);
        star4Btn.setOnClickListener(this);
        starList.add(star4Btn);
        star5Btn = (Button) parent.findViewById(com.yw.car.R.id.star5_btn);
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.yw.car.R.id.star1_btn:
                rank = 0;
                break;
            case com.yw.car.R.id.star2_btn:
                rank = 1;
                break;
            case com.yw.car.R.id.star3_btn:
                rank = 2;
                break;
            case com.yw.car.R.id.star4_btn:
                rank = 3;
                break;
            case com.yw.car.R.id.star5_btn:
                rank = 4;
                break;
        }
        checkStart(rank);
    ...
    public void checkStart(int rank) {
        for (int i = 0; i < 5; i++) {
            ...
            if (i <= rank)
                starBtn.setBackgroundResource(com.yw.car.R.drawable.icon_start_checked_normal);
            else
                starBtn.setBackgroundResource(com.yw.car.R.drawable.icon_start_uncheck_normal);
        }
    }
