...
public class CountdownView extends View {
    ...
    public CountdownView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, com.yw.car.R.styleable.CountdownView);
        mTimeBgColor = ta.getColor(com.yw.car.R.styleable.CountdownView_timeBgColor, 0xFF444444);
        mTimeBgRadius = ta.getDimension(com.yw.car.R.styleable.CountdownView_timeBgRadius, 0);
        isShowTimeBgDivisionLine = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowTimeBgDivisionLine, true);
        mTimeBgDivisionLineColor = ta.getColor(com.yw.car.R.styleable.CountdownView_timeBgDivisionLineColor, Color.parseColor("#30FFFFFF"));
        mTimeBgDivisionLineSize = ta.getDimension(com.yw.car.R.styleable.CountdownView_timeBgDivisionLineSize, dp2px(DEFAULT_TIME_BG_DIVISION_LINE_SIZE));
        mTimeBgSize = ta.getDimension(com.yw.car.R.styleable.CountdownView_timeBgSize, 0);
        isTimeTextBold = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isTimeTextBold, false);
        mTimeTextSize = ta.getDimension(com.yw.car.R.styleable.CountdownView_timeTextSize, sp2px(12));
        mTimeTextColor = ta.getColor(com.yw.car.R.styleable.CountdownView_timeTextColor, 0xFF000000);
        isHideTimeBackground = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isHideTimeBackground, true);
        isShowDay = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowDay, false);
        isShowHour = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowHour, false);
        isShowMinute = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowMinute, true);
        isShowSecond = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowSecond, true);
        isShowMillisecond = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isShowMillisecond, false);
        mHasSetIsShowDay = ta.hasValue(com.yw.car.R.styleable.CountdownView_isShowDay);
        mHasSetIsShowHour = ta.hasValue(com.yw.car.R.styleable.CountdownView_isShowHour);
        isSuffixTextBold = ta.getBoolean(com.yw.car.R.styleable.CountdownView_isSuffixTextBold, false);
        mSuffixTextSize = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixTextSize, sp2px(12));
        mSuffixTextColor = ta.getColor(com.yw.car.R.styleable.CountdownView_suffixTextColor, 0xFF000000);
        mSuffix = ta.getString(com.yw.car.R.styleable.CountdownView_suffix);
        mSuffixDay = ta.getString(com.yw.car.R.styleable.CountdownView_suffixDay);
        mSuffixHour = ta.getString(com.yw.car.R.styleable.CountdownView_suffixHour);
        mSuffixMinute = ta.getString(com.yw.car.R.styleable.CountdownView_suffixMinute);
        mSuffixSecond = ta.getString(com.yw.car.R.styleable.CountdownView_suffixSecond);
        mSuffixMillisecond = ta.getString(com.yw.car.R.styleable.CountdownView_suffixMillisecond);
        mSuffixGravity = 1;
        mSuffixLRMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixLRMargin, -1);
        mSuffixDayLeftMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixDayLeftMargin, -1);
        mSuffixDayRightMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixDayRightMargin, -1);
        mSuffixHourLeftMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixHourLeftMargin, -1);
        mSuffixHourRightMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixHourRightMargin, -1);
        mSuffixMinuteLeftMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixMinuteLeftMargin, -1);
        mSuffixMinuteRightMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixMinuteRightMargin, -1);
        mSuffixSecondLeftMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixSecondLeftMargin, -1);
        mSuffixSecondRightMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixSecondRightMargin, -1);
        mSuffixMillisecondLeftMargin = ta.getDimension(com.yw.car.R.styleable.CountdownView_suffixMillisecondLeftMargin, -1);
        ta.recycle();
