...
import com.yw.car.activity.person.user.SPPayPwdActivity_;
...
public class KeyboardDialog extends Dialog implements View.OnClickListener {
    ...
    public KeyboardDialog(Context context) {
        super(context, com.yw.car.R.style.keyboard_dialog);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.yw.car.R.layout.dialog_keyboard);
    ...
    private void initView() {
        ImageView ivCloseKey = (ImageView) findViewById(com.yw.car.R.id.iv_close_key);
        pwdEt = (EditText) findViewById(com.yw.car.R.id.pwd_et);
        TextView sureTvt = (TextView) findViewById(com.yw.car.R.id.sure_tvt);
        TextView tvForget = (TextView) findViewById(com.yw.car.R.id.tv_forget_psw);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case com.yw.car.R.id.iv_close_key:        //关闭dialog
                pwdEt.setText("");
                pwdEt.clearFocus();
                ...
                dismiss();
                break;
            case com.yw.car.R.id.sure_tvt:        //确定密码
                if (mListener != null) {
                    mListener.getPwd();
                    dismiss();
                }
                break;
            case com.yw.car.R.id.tv_forget_psw:       //忘记密码
