package com.yw.car.widget.tagview;
...
public class FlowLayout extends ViewGroup {
    ...
    private void readStyleParameters(Context context, AttributeSet attributeSet) {
        TypedArray a = context.obtainStyledAttributes(attributeSet, com.yw.car.R.styleable.FlowLayout);
        try {
            horizontalSpacing = a.getDimensionPixelSize(com.yw.car.R.styleable.FlowLayout_horizontalSpacing, 0);
            verticalSpacing = a.getDimensionPixelSize(com.yw.car.R.styleable.FlowLayout_verticalSpacing, 0);
            orientation = a.getInteger(com.yw.car.R.styleable.FlowLayout_orientation, HORIZONTAL);
            debugDraw = a.getBoolean(com.yw.car.R.styleable.FlowLayout_debugDraw, false);
        } finally {
            a.recycle();
        }
    }
    ...
    public static class LayoutParams extends ViewGroup.LayoutParams {
        ...
        private void readStyleParameters(Context context, AttributeSet attributeSet) {
            TypedArray a = context.obtainStyledAttributes(attributeSet, com.yw.car.R.styleable.FlowLayout_LayoutParams);
            try {
                horizontalSpacing = a.getDimensionPixelSize(com.yw.car.R.styleable.FlowLayout_LayoutParams_layout_horizontalSpacing, NO_SPACING);
                verticalSpacing = a.getDimensionPixelSize(com.yw.car.R.styleable.FlowLayout_LayoutParams_layout_verticalSpacing, NO_SPACING);
                newLine = a.getBoolean(com.yw.car.R.styleable.FlowLayout_LayoutParams_layout_newLine, false);
            } finally {
                a.recycle();
            }
        }
