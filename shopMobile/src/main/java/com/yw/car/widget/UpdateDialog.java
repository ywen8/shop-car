...
public class UpdateDialog extends Dialog {
    ...
    public static class Builder {
        ...
        public UpdateDialog create() {
            ...
            final UpdateDialog dialog = new UpdateDialog(context, com.yw.car.R.style.dialog);
            View layout = inflater.inflate(com.yw.car.R.layout.update_view, null);
            View view = layout.findViewById(com.yw.car.R.id.dialog_ll);
            ...
            cancelBtn = (Button) layout.findViewById(com.yw.car.R.id.cancelBtn);
            downloadBtn = (Button) layout.findViewById(com.yw.car.R.id.downloadBtn);
            if (message != null) ((TextView) layout.findViewById(com.yw.car.R.id.updateMsg)).setText(message);
