...
import com.yw.car.adapter.SPProductListSecAdapter;
import com.yw.car.adapter.SPShopcartListAdapter;
...
import com.yw.car.model.shop.SPJsonArray;
...
public class SPShopCartFragment extends SPBaseFragment implements View.OnClickListener, SPShopcartListAdapter.ShopCarClickListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.yw.car.R.layout.shopcart_fragment, null, false);
        mEmptyHeaderView = inflater.inflate(com.yw.car.R.layout.shopcart_empty_header, null);
        mEmptyFooterView = inflater.inflate(com.yw.car.R.layout.shopcart_empty_footer, null);
        super.init(view);
        return view;
    }
    ...
    public void initSubView(View view) {
        view.findViewById(com.yw.car.R.id.titlebar_back_rl).setVisibility(View.GONE);
        refreshRecyclerView = (SuperRefreshRecyclerView) view.findViewById(com.yw.car.R.id.super_recyclerview);
        TextView titleTxtv = (TextView) view.findViewById(com.yw.car.R.id.titlebar_title_txtv);
        titleTxtv.setText(getString(com.yw.car.R.string.title_shopcart));
        totalfeeTxtv = (TextView) view.findViewById(com.yw.car.R.id.totalfee_txtv);
        cutfeeTxtv = (TextView) view.findViewById(com.yw.car.R.id.cutfee_txtv);
        checkallBtn = (Button) view.findViewById(com.yw.car.R.id.checkall_btn);
        ...
        Drawable drawable = getResources().getDrawable(com.yw.car.R.drawable.divider_white_large);
        ...
        mEmptyRecyclerView = (RecyclerView) view.findViewById(com.yw.car.R.id.cart_empty_listv);
        ...
        View emptyView = view.findViewById(com.yw.car.R.id.empty_lstv);
        refreshRecyclerView.setEmptyView(emptyView);
        mLoginBtn = (Button) mEmptyHeaderView.findViewById(com.yw.car.R.id.login_btn);
        emptyHintTxtv = (TextView) mEmptyHeaderView.findViewById(com.yw.car.R.id.cart_empty_hint_txtv);
    }
    ...
    public void refreshData() {
        ...
        if (SPMobileApplication.getInstance().isLogined()) {        //如果已经登录,隐藏登录按钮
            emptyHintTxtv.setText(getString(com.yw.car.R.string.hint_cart_empty_login));
            mLoginBtn.setVisibility(View.INVISIBLE);
        } else {
            emptyHintTxtv.setText(getString(com.yw.car.R.string.hint_cart_empty_nologin));
    ...
    public void dealModels(List<SPStore> stores) {
        ...
        if (stores == null || stores.size() < 1) {
            ...
            cutFee = 0.00;
            refreshFeeView();
            checkallBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checkno);
    ...
    public void refreshFeeView() {
        ...
        totalFeeSpanStr.setSpan(new ForegroundColorSpan(getResources().getColor(com.yw.car.R.color.light_red)), startIndex, endIndex,
        ...
        if (isAllCheck)
            checkallBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checked);
        else
            checkallBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checkno);
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.checkall_btn:        //全选或全不选
                isShowSmallLoading = true;
                checkAllOrNo();
                break;
            case com.yw.car.R.id.buy_btn:        //去结算
                ...
                gotoConfirmOrder();
                break;
            case com.yw.car.R.id.login_btn:         //用户登录
                Intent loginIntent = new Intent(getActivity(), SPLoginActivity_.class);
                startActivityForResult(loginIntent, SPMobileConstants.Result_Code_Login_Refresh);
                break;
        }
