...
import com.yw.car.activity.shop.SPProductListSearchResultActivity;
import com.yw.car.adapter.SPProductListFilterAdapter;
...
public class SPProductListFilterFragment extends Fragment implements TagListView.OnTagCheckedChangedListener, TagListView.OnTagClickListener {
    ...
    private void initView(LayoutInflater inflater, ViewGroup container) {
        mView = inflater.inflate(com.yw.car.R.layout.fragment_spproduct_list_filter, container, false);
        ListView mFilterListv = (ListView) mView.findViewById(com.yw.car.R.id.product_filter_lstv);
