...
import com.yw.car.activity.person.SPCollectListActivity;
import com.yw.car.activity.shop.SPStoreHomeActivity_;
import com.yw.car.adapter.ListDividerItemDecoration;
import com.yw.car.adapter.SPStoreCollectListAdapter;
...
public class SPStoreCollectFragment extends SPBaseFragment implements OnRefreshListener, SPStoreCollectListAdapter.StoreCollectListener,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View view = inflater.inflate(com.yw.car.R.layout.person_goods_collect_list, null, false);
        super.init(view);
        return view;
    }
