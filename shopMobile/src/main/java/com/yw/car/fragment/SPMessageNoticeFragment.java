...
import com.yw.car.adapter.SPMessageAssetAdapter;
import com.yw.car.adapter.SPMessageLogisticsAdapter;
import com.yw.car.adapter.SPMessageNoticeAdapter;
import com.yw.car.adapter.SPMessageServiceAdapter;
...
public class SPMessageNoticeFragment extends SPBaseFragment implements OnRefreshListener, OnLoadMoreListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(com.yw.car.R.layout.message_notice_fragment, null, false);
        super.init(view);
        return view;
    }
