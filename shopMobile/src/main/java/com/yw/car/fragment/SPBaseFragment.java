...
public abstract class SPBaseFragment extends Fragment implements SPIViewController {
    ...
    public boolean isVisibleToUser = false;              //界面对于用户是否可见
    ...
    public void showToastUnLogin() {
        showToast(getString(com.yw.car.R.string.toast_person_unlogin));
    }
    ...
    public void showSuccessToast(String txt) {
        CustomToast.getToast().ToastShow(getContext(), txt, com.yw.car.R.drawable.success);
    }

    public void showFailedToast(String txt) {
        CustomToast.getToast().ToastShow(getContext(), txt, com.yw.car.R.drawable.fail);
    }
    ...
    public void showConfirmDialog(String message, String title, String okText, final SPConfirmDialog.ConfirmDialogListener confirmDialogListener,
        ...
        builder.setNegativeButton(getResources().getString(com.yw.car.R.string.cancel), new android.content.DialogInterface.OnClickListener() {
            public void onClick(DialogInterface dialog, int which) {
                dialog.dismiss();
            }
        });
    ...
    public void showConfirmDialog(String message, String title, final SPConfirmDialog.ConfirmDialogListener confirmDialogListener,
                                  final int actionType) {
        showConfirmDialog(message, title, getResources().getString(com.yw.car.R.string.ok), confirmDialogListener, actionType);
    }
