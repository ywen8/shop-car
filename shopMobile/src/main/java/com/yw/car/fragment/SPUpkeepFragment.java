...
public class SPUpkeepFragment extends SPBaseFragment {
    private static SPUpkeepFragment mFragment;
    ...
    public static SPUpkeepFragment newInstance() {
        if (mFragment == null)
            mFragment = new SPUpkeepFragment();
        return mFragment;
    }
}
