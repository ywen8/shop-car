...
import com.yw.car.adapter.SPDistributeListFilterAdapter;
...
public class SPDistributeListFilterFragment extends Fragment implements SPDistributeListFilterAdapter.OnItemclickListener {
    ...
    private void initView(LayoutInflater inflater, ViewGroup container) {
        mView = inflater.inflate(com.yw.car.R.layout.fragment_spdistribute_list_filter, container, false);
        ExpandableListView expandablelistview = (ExpandableListView) mView.findViewById(com.yw.car.R.id.expandablelistview);
