...
public class SPCarTypeAdapter extends RecyclerView.Adapter<SPCarTypeAdapter.MyViewHolder> {
    public List<SPCarBrand> brands;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        SPCarTypeAdapter.MyViewHolder carTypeAdapter = new SPCarTypeAdapter.MyViewHolder(view);
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SPCarBrand spCarBrand = brands.get(position);
        holder.chepinpai.setText(spCarBrand.getBrandName());
    ...
    public SPCarTypeAdapter(List<SPCarBrand> brands, Context mContext, CarTypeItemListener listener) {
        this.brands = brands;
    ...
    public interface CarTypeItemListener {
        void carTypeItemClick(SPCarBrand name);
    }
}
