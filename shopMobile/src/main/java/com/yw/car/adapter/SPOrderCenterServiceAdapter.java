...
public class SPOrderCenterServiceAdapter extends SectionedRecyclerViewAdapter<SPOrderCenterServiceAdapter.HeaderViewHolder,
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.order_list_item_service_header, parent, false);
    ...
    protected FooterViewHolder onCreateSectionFooterViewHolder(ViewGroup parent, int viewType) {
        mInflater = LayoutInflater.from(parent.getContext());
        View view = mInflater.inflate(com.yw.car.R.layout.order_list_item_service_footer, parent, false);
    ...
    protected OrderItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        mInflater = LayoutInflater.from(parent.getContext());
        View view = mInflater.inflate(com.yw.car.R.layout.order_list_item_service_details, parent, false);
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            super(itemView);
            headerStoreImg = (ImageView) itemView.findViewById(com.yw.car.R.id.store_iv);          //图片
            headerName = (TextView) itemView.findViewById(com.yw.car.R.id.store_name_txtv);        //商店名称
        }
    }
    ...
    public class FooterViewHolder extends RecyclerView.ViewHolder {
        ...
        public FooterViewHolder(View itemView) {
            super(itemView);
            footerBtnRelativeLayout = (RelativeLayout) itemView.findViewById(com.yw.car.R.id.btn_img_rl);
            footerDescribe = (TextView) itemView.findViewById(com.yw.car.R.id.btn_describe);
            footerBtnImg = (ImageView) itemView.findViewById(com.yw.car.R.id.btn_img);
            footerBtnText = (TextView) itemView.findViewById(com.yw.car.R.id.order_show_btn);
        }
    }
    ...
    class OrderItemViewHolder extends RecyclerView.ViewHolder {
        ...
        OrderItemViewHolder(View itemView) {
            super(itemView);
            DetailsImg = (ImageView) itemView.findViewById(com.yw.car.R.id.product_pic_imgv);
            DetailsText = (TextView) itemView.findViewById(com.yw.car.R.id.product_name_txtv);
            DetailsLinear = (LinearLayout) itemView.findViewById(com.yw.car.R.id.order_button_layout);
        }
    }
