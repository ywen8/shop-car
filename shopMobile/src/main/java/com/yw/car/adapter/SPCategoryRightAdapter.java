...
public class SPCategoryRightAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter, View.OnClickListener {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.category_right_item, parent, false);
            holder.r1View = convertView.findViewById(com.yw.car.R.id.category_item_r1_layout);
            holder.r1Imgv = (ImageView) convertView.findViewById(com.yw.car.R.id.category_item_r1_imgv);
            holder.r1Txtv = (TextView) convertView.findViewById(com.yw.car.R.id.category_item_r1_txtv);
        ...
        if (position < mCategoryLst.size()) {
            ...
            if (!SPStringUtils.isEmpty(category.getImage())) {
                ...
                Glide.with(mContext).load(imgUrl).asBitmap().fitCenter().placeholder(com.yw.car.R.drawable.category_default)
                        .diskCacheStrategy(DiskCacheStrategy.SOURCE).into(holder.r1Imgv);
            } else {
                holder.r1Imgv.setImageResource(com.yw.car.R.drawable.category_default);
            }
        }
        return convertView;
    }
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.category_grid_ad_title_item, parent, false);
            headerHolder.titleTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.catelogy_right_title_txtv);
            headerHolder.adImgv = (ImageView) convertView.findViewById(com.yw.car.R.id.catelogy_right_title_ad_imgv);
    ...
    public void onClick(View v) {
        String catId = null;
        if (v.getId() == com.yw.car.R.id.catelogy_right_title_txtv)
