...
import com.yw.car.R;
import com.yw.car.activity.shop.SPStoreHomeActivity;
import com.yw.car.activity.shop.SPStoreMapActivity_;
import com.yw.car.activity.shop.SPStoreProductListActivity;
...
public class SPStoreHomeAdapter extends SectionedRecyclerViewAdapter<SPStoreHomeAdapter.HeaderViewHolder, SPStoreHomeAdapter.GoodsItemViewHolder,
    ...
    protected void onBindSectionHeaderViewHolder(final HeaderViewHolder holder, int section) {
        ...
        if (section == 0) {
            ...
            holder.goStoreBtn.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(mContext, SPStoreMapActivity_.class);
    ...
    class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            ...
            goStoreBtn = (Button) itemView.findViewById(R.id.go_store_btn);
