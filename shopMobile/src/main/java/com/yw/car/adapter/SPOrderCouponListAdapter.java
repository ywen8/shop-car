...
public class SPOrderCouponListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.order_coupon_list_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (!SPStringUtils.isEmpty(money))
            ...
            moneyFmt = "¥0";
        float fontSize = mContext.getResources().getDimension(com.yw.car.R.dimen.textSizeNormal);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            couponLayout = itemView.findViewById(com.yw.car.R.id.coupon_layout);
            moneyTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.coupon_money_txtv);
            conditionTv = (TextView) itemView.findViewById(com.yw.car.R.id.condition_txtv);
            couponTitle = (TextView) itemView.findViewById(com.yw.car.R.id.coupon_title_txtv);
            couponLimit = (TextView) itemView.findViewById(com.yw.car.R.id.coupon_limit_txtv);
            couponName = (TextView) itemView.findViewById(com.yw.car.R.id.coupon_name_txtv);
