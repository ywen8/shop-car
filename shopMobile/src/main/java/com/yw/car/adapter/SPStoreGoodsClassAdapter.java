...
import com.yw.car.model.SPStoreGoodsClass;
...
public class SPStoreGoodsClassAdapter extends BaseAdapter implements StickyGridHeadersSimpleAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.store_goods_class_item, parent, false);
            holder.classLayout = (LinearLayout) convertView.findViewById(com.yw.car.R.id.class_layout);
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.store_goods_class_grid_title_item, parent, false);
            headerHolder.titleTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.store_goods_class_title_txtv);
            headerHolder.lookMoreTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.look_more_txtv);
