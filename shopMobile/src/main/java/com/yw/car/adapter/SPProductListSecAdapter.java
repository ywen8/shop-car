...
public class SPProductListSecAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.product_list_recy_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            nameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.product_name_txtv);
            priceTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.product_price_txtv);
            picImgv = (ImageView) itemView.findViewById(com.yw.car.R.id.product_pic_imgv);
            commentTv = (TextView) itemView.findViewById(com.yw.car.R.id.comment_tv);
            commentRateTv = (TextView) itemView.findViewById(com.yw.car.R.id.comment_rate_tv);
