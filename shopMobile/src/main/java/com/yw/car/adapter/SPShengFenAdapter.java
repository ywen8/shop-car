...
public class SPShengFenAdapter extends RecyclerView.Adapter<SPShengFenAdapter.MyViewHolder> {
    public List<SPProvince> list;
    public Context mContext;
    private ShengFenSelect shengFenSelect;

    public SPShengFenAdapter(List<SPProvince> list, Context mContext, ShengFenSelect shengFenSelect) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SPProvince spProvince = list.get(position);
        holder.shengfen.setText(spProvince.proName);
    ...
    public interface ShengFenSelect {
        void onClickItemShgneFen(SPProvince spProvince);
    }
}
