...
public class SPBrowsingHistoryAdapter extends SectionedRecyclerViewAdapter<SPBrowsingHistoryAdapter.HeaderViewHolder,
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.browing_header, parent, false);
    ...
    protected HistoryItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.browing_item, parent, false);
    ...
    protected void onBindItemViewHolder(HistoryItemViewHolder holder, int section, int position) {
        ...
        float fontSize = this.mContext.getResources().getDimension(com.yw.car.R.dimen.textSizeSmall);
    ...
    class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            super(itemView);
            browTime = (TextView) itemView.findViewById(com.yw.car.R.id.brow_time);
            browTimeLine = itemView.findViewById(com.yw.car.R.id.brow_time_line);
        }
    }
    ...
    class HistoryItemViewHolder extends RecyclerView.ViewHolder {
        ...
        HistoryItemViewHolder(View itemView) {
            super(itemView);
            goodImg = (ImageView) itemView.findViewById(com.yw.car.R.id.goodImg);
            goodName = (TextView) itemView.findViewById(com.yw.car.R.id.goodName);
            goodPrice = (TextView) itemView.findViewById(com.yw.car.R.id.goodPrice);
            browBtn = (Button) itemView.findViewById(com.yw.car.R.id.browBtn);
