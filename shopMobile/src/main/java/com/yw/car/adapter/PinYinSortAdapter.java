...
public class PinYinSortAdapter extends BaseAdapter implements SectionIndexer {
    ...
    public View getView(final int position, View view, ViewGroup arg2) {
        ...
        if (view == null) {
            ...
            view = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.pinyin_item, null);
            viewHolder.tvTitle = (TextView) view.findViewById(com.yw.car.R.id.title);
            viewHolder.tvLetter = (TextView) view.findViewById(com.yw.car.R.id.catalog);
