...
public class SPProductShowListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.product_show_list_item, parent, false);
            holder.picIngv = (ImageView) convertView.findViewById(com.yw.car.R.id.product_pic_imgv);
            holder.nameTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.product_name_txtv);
            holder.specTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.product_spec_txtv);
            holder.countTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.product_count_txtv);
            holder.priceTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.product_price_txtv);
            holder.applyReturnBtn = (Button) convertView.findViewById(com.yw.car.R.id.product_apply_return_btn);
            holder.commentBtn = (Button) convertView.findViewById(com.yw.car.R.id.product_apply_comment_btn);
