...
public class SPCarXiLieAdapter extends RecyclerView.Adapter<SPCarXiLieAdapter.MyViewHolder> {
    public List<SPXiLieConent> list;
    public Context mContext;
    private ShengFenSelect shengFenSelect;

    public SPCarXiLieAdapter(List<SPXiLieConent> list, Context mContext, ShengFenSelect shengFenSelect) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SPXiLieConent spProvince = list.get(position);
        holder.shengfen.setText(spProvince.xlname);
    ...
    public interface ShengFenSelect {
        void onClickItemShgneFen(SPXiLieConent spProvince);
    }
}
