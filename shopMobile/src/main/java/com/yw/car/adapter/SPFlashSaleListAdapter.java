...
public class SPFlashSaleListAdapter extends RecyclerView.Adapter<SPFlashSaleListAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.yw.car.R.layout.flash_sale_list_item, parent, false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        if (mFlashTime.getType() == 1) {
            holder.buyTxtv.setBackgroundColor(mContext.getResources().getColor(com.yw.car.R.color.light_red));
            holder.buyTxtv.setText(mContext.getString(com.yw.car.R.string.flash_sale));
        } else {
            holder.buyTxtv.setBackgroundColor(mContext.getResources().getColor(com.yw.car.R.color.light_green));
            holder.buyTxtv.setText(mContext.getString(com.yw.car.R.string.go_buy));
        }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            picImgv = (ImageView) itemView.findViewById(com.yw.car.R.id.product_pic_imgv);
            productNameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.product_name_txtv);
            priceTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.price_txtv);
            ...
            percentTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.percent_txtv);
            buyTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.buy_txtv);
        }
    }
