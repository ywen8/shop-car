...
public class SPProductListHomeAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.product_recy_home_item, parent, false);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case com.yw.car.R.id.product_pic_imgv:
                break;
            case com.yw.car.R.id.similar_btn:
                break;
        }
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            similarBtn = (Button) itemView.findViewById(com.yw.car.R.id.similar_btn);
