...
public class SPSearchkeyListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.common_search_key_item, parent, false);
            holder.keyTxtv = (TextView) convertView.findViewById(com.yw.car.R.id.search_item_key_txtv);
