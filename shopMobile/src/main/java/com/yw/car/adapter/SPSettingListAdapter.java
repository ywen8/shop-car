...
public class SPSettingListAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = LayoutInflater.from(mContext).inflate(com.yw.car.R.layout.person_settings_list_item, parent, false);
            holder.settingArrow = (SPArrowRowView) convertView.findViewById(com.yw.car.R.id.person_setting_item);
