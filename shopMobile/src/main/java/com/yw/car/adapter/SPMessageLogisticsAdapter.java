...
import com.yw.car.activity.person.order.SPOrderDetailActivity_;
import com.yw.car.common.SPMobileConstants;
import com.yw.car.model.SPMessageList;
import com.yw.car.model.SPMessageListData;
...
public class SPMessageLogisticsAdapter extends SectionedRecyclerViewAdapter<SPMessageLogisticsAdapter.HeaderViewHolder,
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.message_list_item_time_header_empty, parent, false);
    ...
    protected OrderItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        mInflater = LayoutInflater.from(parent.getContext());
        View view = mInflater.inflate(com.yw.car.R.layout.message_list_item_asset, parent, false);
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            super(itemView);
            shoppingTitleLl = ((LinearLayout) itemView.findViewById(com.yw.car.R.id.shopping_title_ll));
        }
    }
    ...
    class OrderItemViewHolder extends RecyclerView.ViewHolder {
        ...
        OrderItemViewHolder(View itemView) {
            super(itemView);
            titleText = (TextView) itemView.findViewById(com.yw.car.R.id.title_text);
            titleInfo = (TextView) itemView.findViewById(com.yw.car.R.id.title_info);
            cardView = (CardView) itemView.findViewById(com.yw.car.R.id.cardView);
            infoIv = (ImageView) itemView.findViewById(com.yw.car.R.id.info_iv);
        }
    }
