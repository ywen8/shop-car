...
public class SPShopcartListAdapter extends SectionedRecyclerViewAdapter<SPShopcartListAdapter.HeaderViewHolder, SPShopcartListAdapter.ItemViewHolder,
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.yw.car.R.layout.cart_section_item, parent, false);
        return new HeaderViewHolder(view);
    }

    @Override
    protected ItemViewHolder onCreateItemViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(com.yw.car.R.layout.shopcart_list_item, parent, false);
    ...
    protected void onBindSectionHeaderViewHolder(HeaderViewHolder holder, int section) {
        ...
        Glide.with(mContext).load(SPUtils.getImageUrl(store.getStoreLogo())).asBitmap().fitCenter().placeholder(com.yw.car.R.drawable.icon_enter_store)
        ...
        if ("1".equals(store.getSelected()))
            holder.storeCheckBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checked);
        else
            holder.storeCheckBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checkno);
    ...
    protected void onBindItemViewHolder(ItemViewHolder holder, int section, int position) {
        ...
        if (product.getStoreCount() > 0 && product.getSelected().equals("1"))
            holder.checkBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checked);
        else
            holder.checkBtn.setBackgroundResource(com.yw.car.R.drawable.icon_checkno);
        String thumlUrl = product.getImageThumlUrl();
        Glide.with(mContext).load(thumlUrl).asBitmap().fitCenter().placeholder(com.yw.car.R.drawable.icon_product_null)
    ...
    class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemViewHolder(View itemView) {
            super(itemView);
            nameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.name_txtv);
            specTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.product_spec_txtv);
            picImgv = (ImageView) itemView.findViewById(com.yw.car.R.id.pic_imgv);
            nogoodImg = (ImageView) itemView.findViewById(com.yw.car.R.id.nogoodImg);
            shopPriceTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.shop_price_txtv);
            marketPriceTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.market_price_txtv);
            cartCountTxtv = (EditText) itemView.findViewById(com.yw.car.R.id.cart_count_dtxtv);
            minusBtn = (Button) itemView.findViewById(com.yw.car.R.id.cart_minus_btn);
            plusBtn = (Button) itemView.findViewById(com.yw.car.R.id.cart_plus_btn);
            checkBtn = (Button) itemView.findViewById(com.yw.car.R.id.check_btn);
            delBtn = (ImageButton) itemView.findViewById(com.yw.car.R.id.del_btn);
        }
    }
    ...
    class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            super(itemView);
            storeLl = (LinearLayout) itemView.findViewById(com.yw.car.R.id.store_ll);
            storeLogo = (ImageView) itemView.findViewById(com.yw.car.R.id.store_logo);
            storeCheckBtn = (Button) itemView.findViewById(com.yw.car.R.id.store_check_btn);
            storeNameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.store_name_txtv);
        }
    }
