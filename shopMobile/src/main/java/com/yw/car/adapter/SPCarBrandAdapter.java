...
public class SPCarBrandAdapter extends RecyclerView.Adapter<SPCarBrandAdapter.MyViewHolder> {
    public List<SPBrandCar> list;
    public Context mContext;
    private ShengFenSelect shengFenSelect;

    public SPCarBrandAdapter(List<SPBrandCar> list, Context mContext, ShengFenSelect shengFenSelect) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        final SPBrandCar spProvince = list.get(position);
        holder.shengfen.setText(spProvince.big_ppname);
    ...
    public interface ShengFenSelect {
        void onClickItemShgneFen(SPBrandCar spProvince);
    }
}
