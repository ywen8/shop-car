...
public class SPOrderCenterListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.order_center_list_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, final int position) {
        ...
        if (mType == 0) {
            ...
            holder.imgBtn.setImageResource(com.yw.car.R.drawable.order_center_message);
            holder.imgBtnBorder.setBackgroundResource(com.yw.car.R.drawable.button_border_r_selector);
            ...
            holder.imgBtn.setImageResource(com.yw.car.R.drawable.order_center_look);
            holder.useBtn.setTextColor(mContext.getResources().getColor(com.yw.car.R.color.button_bg_gray));
            holder.useBtn.setText("查看评价");
            holder.imgBtnBorder.setBackgroundResource(com.yw.car.R.drawable.button_border_w_selector);
            holder.imgBtnBorder.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            ...
            conditionTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.condition_txtv);
            useBtn = (TextView) itemView.findViewById(com.yw.car.R.id.order_show_btn);
            imgBtn = (ImageView) itemView.findViewById(com.yw.car.R.id.btn_img);
            imgBtnBorder = (RelativeLayout) itemView.findViewById(com.yw.car.R.id.btn_img_rl);
        }
    }
