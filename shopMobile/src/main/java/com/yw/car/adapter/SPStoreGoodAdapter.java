...
public class SPStoreGoodAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.distribute_store_item, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            goodImg = (ImageView) itemView.findViewById(com.yw.car.R.id.good_pic);
            goodName = (TextView) itemView.findViewById(com.yw.car.R.id.good_name);
            goodPrice = (TextView) itemView.findViewById(com.yw.car.R.id.good_price);
        }
    }
