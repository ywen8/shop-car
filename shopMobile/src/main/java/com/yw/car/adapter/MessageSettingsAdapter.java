...
public class MessageSettingsAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView == null) {
            ...
            convertView = mInflater.inflate(com.yw.car.R.layout.message_settings_list_item, null);
            holder.title = (TextView) convertView.findViewById(com.yw.car.R.id.mes_set_tv);
            holder.switchButton = (SwitchButton) convertView.findViewById(com.yw.car.R.id.mes_set_tb);
