...
public class SPConfirmOrderAdapter extends RecyclerView.Adapter implements View.OnClickListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        return new ItemViewHolder(mLayoutInflater.inflate(com.yw.car.R.layout.order_confirm_order_item, null, false));
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (store.getSelerMessage() == null || store.getSelerMessage().equals(""))
            viewHolder.selerMessageArv.setSubText(mContext.getString(com.yw.car.R.string.send_seler_message));
        else
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case com.yw.car.R.id.order_coupon_aview:
                mListener.coupontItemClick(store);
                break;
            case com.yw.car.R.id.order_seler_message_aview:
    ...
    private class ItemViewHolder extends RecyclerView.ViewHolder {
        ...
        ItemViewHolder(View itemView) {
            super(itemView);
            productLayout = (NoScrollListView) itemView.findViewById(com.yw.car.R.id.order_product_layout);
            storeNameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.store_name_txtv);
            storePromTitle = (TextView) itemView.findViewById(com.yw.car.R.id.store_prom_title_tv);
            storeFeeTv = (TextView) itemView.findViewById(com.yw.car.R.id.store_fee_tv);
            couponArv = (SPArrowRowView) itemView.findViewById(com.yw.car.R.id.order_coupon_aview);
            selerMessageArv = (SPArrowRowView) itemView.findViewById(com.yw.car.R.id.order_seler_message_aview);
            selerMessageArv.setSubText(mContext.getString(com.yw.car.R.string.send_seler_message));
            if (isIntegralGood)
