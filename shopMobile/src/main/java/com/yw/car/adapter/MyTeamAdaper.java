...
public class MyTeamAdaper extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.distribution_team_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (uri != null)
            ...
            viewholder.teamImg.setImageURI(new Uri.Builder().scheme("res").path(String.valueOf(com.yw.car.R.drawable.person_default_head)).build());
    }
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            teamImg = (SimpleDraweeView) itemView.findViewById(com.yw.car.R.id.teamImg);
            teamName = (TextView) itemView.findViewById(com.yw.car.R.id.teamName);
            teamTime = (TextView) itemView.findViewById(com.yw.car.R.id.teamTime);
            teamDistribute = (TextView) itemView.findViewById(com.yw.car.R.id.teamDistribute);
        }
    }
