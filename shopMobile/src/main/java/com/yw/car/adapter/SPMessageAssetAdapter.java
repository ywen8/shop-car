...
public class SPMessageAssetAdapter extends SectionedRecyclerViewAdapter<SPMessageAssetAdapter.HeaderViewHolder,
    ...
    protected HeaderViewHolder onCreateSectionHeaderViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.message_list_item_time_header, parent, false);
    ...
    public class HeaderViewHolder extends RecyclerView.ViewHolder {
        ...
        public HeaderViewHolder(View itemView) {
            super(itemView);
            timeText = ((TextView) itemView.findViewById(com.yw.car.R.id.time_text));
        }
    }
    ...
    class OrderItemViewHolder extends RecyclerView.ViewHolder {
        ...
        OrderItemViewHolder(View itemView) {
            ...
            infoTv = (TextView) itemView.findViewById(com.yw.car.R.id.info_tv);
