...
import com.yw.car.activity.person.address.SPConsigneeAddressListActivity;
...
public class SPAddressListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements SPConfirmDialog.ConfirmDialogListener {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.person_address_list_item_new, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            consigneeTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.address_consignee_txtv);
            mobileTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.address_mobile_txtv);
            addressTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.address_detail_txtv);
            editBtn = (ImageView) itemView.findViewById(com.yw.car.R.id.address_edit_btn);
            setDefaultTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.address_default_txtv);
        }
    }
