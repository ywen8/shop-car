...
public class SPCouponListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = mInflater.inflate(com.yw.car.R.layout.person_coupon_list_item, parent, false);
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        if (!SPStringUtils.isEmpty(money))
            ...
            moneyFmt = "¥0";
        float fontSize = mContext.getResources().getDimension(com.yw.car.R.dimen.textSizeMedium);
        ...
        switch (this.mType) {
            case 0:      //未使用
                ...
                holder.couponTopRlayout.setBackgroundColor(mContext.getResources().getColor(com.yw.car.R.color.coupon_blue));
                holder.useBtn.setBackground(mContext.getResources().getDrawable(com.yw.car.R.drawable.btn_coupon_blue));
                holder.useBtn.setTextColor(mContext.getResources().getColor(com.yw.car.R.color.coupon_blue));
                break;
            case 1:      //已使用
                ...
                holder.couponTopRlayout.setBackgroundColor(mContext.getResources().getColor(com.yw.car.R.color.coupon_gray));
                holder.useBtn.setBackground(mContext.getResources().getDrawable(com.yw.car.R.drawable.btn_coupon_gray));
                holder.useBtn.setTextColor(mContext.getResources().getColor(com.yw.car.R.color.coupon_gray));
                break;
            case 2:      //已过期
                if (!SPStringUtils.isEmpty(coupon.getUseTime()))
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            couponRlayout = itemView.findViewById(com.yw.car.R.id.coupon_rlayout);
            couponTopRlayout = itemView.findViewById(com.yw.car.R.id.coupon_top_rlayout);
            nameTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.name_txtv);
            moneyTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.coupon_money_txtv);
            useEndTimeTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.use_end_time_txtv);
            limitCategoryTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.limit_category_val_txtv);
            limitPlatformTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.limit_platform_val_txtv);
            codeTxtv = (TextView) itemView.findViewById(com.yw.car.R.id.code_val_txtv);
            useBtn = (Button) itemView.findViewById(com.yw.car.R.id.use_btn);
        }
    }
