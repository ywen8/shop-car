...
public class ApplySeriverAdapter extends BaseAdapter {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = layoutInflater.inflate(com.yw.car.R.layout.seriver_pic, null);
            holder.photo = (ImageView) convertView.findViewById(com.yw.car.R.id.photo);
            holder.delete = (ImageView) convertView.findViewById(com.yw.car.R.id.delete);
