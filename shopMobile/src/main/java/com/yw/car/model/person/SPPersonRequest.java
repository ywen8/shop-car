 ...
 * @version V1.0
 */
package com.yw.car.model.person;
...
public class SPPersonRequest {
     ...
     */
    public static void cancelOrder(RequestParams params, final SPSuccessListener successListener, final SPFailuredListener failuredListener) {
        assert (successListener != null);
        assert (failuredListener != null);
