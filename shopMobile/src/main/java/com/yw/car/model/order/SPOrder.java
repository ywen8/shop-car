 ...
 * @version V1.0
 */
package com.yw.car.model.order;
...
public class SPOrder implements SPModel, Serializable {
    ...
    private String integralMoney;                      //金豆抵扣金额
    ...
    public String[] replaceKeyFromPropertyName() {
        return new String[]{
                ...
                "teamFoundObject", "orderTeamFound",
        };
    }
    ...
    public JSONObject getTeamFoundObject() {
        return teamFoundObject;
    }

    public void setTeamFoundObject(JSONObject teamFoundObject) {
        this.teamFoundObject = teamFoundObject;
    }
    ...
    public void setFounder(SPTeamFounder founder) {
