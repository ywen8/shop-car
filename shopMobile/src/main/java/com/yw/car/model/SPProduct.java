...
import com.yw.car.model.shop.SPProductAttribute;
...
public class SPProduct implements SPModel, Serializable, Comparable<SPProduct> {
    ...
    private int giveIntegral;                                          //赠送金豆
    private String storeName;
    private String pointRate;                                          //金豆比例折扣
    ...
    private int exchangeIntegral;                                      //兑换金豆
    ...
    public String[] replaceKeyFromPropertyName() {
        return new String[]{
                ...
                "commentStatisticsObj", "comment_statistics",
                "orderID", "order_id",
                "orderSN", "order_sn",
    ...
    public JSONObject getCommentStatisticsObj() {
        return commentStatisticsObj;
    }

    public void setCommentStatisticsObj(JSONObject commentStatisticsObj) {
        this.commentStatisticsObj = commentStatisticsObj;
    }
