...
public abstract class NiceSpinnerBaseAdapter<T extends SPTown> extends BaseAdapter {
    ...
    public View getView(int position, @Nullable View convertView, ViewGroup parent) {
        ...
        textView.setText(spinnerTextFormatter.format(getItem(position).cityname));
